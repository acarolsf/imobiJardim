...
import br.com.dao.VendaTableModel;
 ...
 * @author Ana Carolina
 */
public class TelaImprimeVenda extends javax.swing.JFrame {

	/**
	 * Creates new form TelaImprimeVenda
	 */
	VendaDao dao = new VendaDao();

	public TelaImprimeVenda() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		VendaTableModel vtm = new VendaTableModel(dao);
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(layout.createSequentialGroup().addGap(297, 297, 297).addComponent(btSair)));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addComponent(jLabel6).addGap(18, 18, 18)
						.addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
						.addGap(32, 32, 32).addComponent(btSair).addGap(40, 40, 40)));
	...
	// java.util.logging.Logger.getLogger(TelaImprimeVenda.class.getName()).log(java.util.logging.Level.SEVERE,
	// null, ex);
	...
	// public void run() {
	// new TelaImprimeVenda().setVisible(true);
	// }
	// });
	// }
